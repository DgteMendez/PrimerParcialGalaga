...
#include "PrimerParcialGalagaProjectile.h"
...
const FName APrimerParcialGalagaPawn::MoveForwardBinding("MoveForward");
const FName APrimerParcialGalagaPawn::MoveRightBinding("MoveRight");
const FName APrimerParcialGalagaPawn::FireForwardBinding("FireForward");
const FName APrimerParcialGalagaPawn::FireRightBinding("FireRight");

APrimerParcialGalagaPawn::APrimerParcialGalagaPawn()
{	
...
void APrimerParcialGalagaPawn::FireShot(FVector FireDirection)
{
	...
	if (bCanFire == true)
	{
		...
		if (FireDirection.SizeSquared() > 0.0f)
		{
			...
			if (World != nullptr)
			{
				...
				World->SpawnActor<APrimerParcialGalagaProjectile>(SpawnLocation, FireRotation);
			}

			bCanFire = false;
			World->GetTimerManager().SetTimer(TimerHandle_ShotTimerExpired, this, &APrimerParcialGalagaPawn::ShotTimerExpired, FireRate);
...
void APrimerParcialGalagaPawn::ShotTimerExpired()
{
	bCanFire = true;
}
