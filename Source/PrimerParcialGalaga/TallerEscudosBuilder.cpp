...
// Sets default values
ATallerEscudosBuilder::ATallerEscudosBuilder()
{
...
void ATallerEscudosBuilder::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void ATallerEscudosBuilder::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void ATallerEscudosBuilder::BuildEstancia(FVector UbiEstans)
{
...
AEstancia* ATallerEscudosBuilder::GetEstancia()
{
	return Estancia;
}
