...
ANaveEnemiga::ANaveEnemiga()
{
	...
	//static ConstructorHelpers::FObjectFinder<UStaticMesh> NaveEnemiga(TEXT("StaticMesh'/Game/StarterContent/Shapes/Shape_Cube.Shape_Cube'"));
	NaveEnemigaMesh = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("NaveEnemigaMesh"));
